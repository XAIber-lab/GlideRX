 ...
 */
@Entity
@Table(name = "predicted_state_vectors")
public class PredictedStateVector implements PositionAwareNode {
    ...
    public PredictedStateVector() {
        
    }
    
    public PredictedStateVector(MapPoint mapPoint, Node icon) {
    ...
    public void updateMapPoint() {
        ...
        this.icon = new Circle(3, Color.RED);
    }
